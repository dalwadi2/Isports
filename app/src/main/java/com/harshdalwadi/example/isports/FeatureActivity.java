...
public class FeatureActivity extends AppCompatActivity {
    ...
    String[] discrate = {"51%","51%","51%","51%","51%","51%","51%","51%","51%","51%","51%","51%",};
    String[] price = {"50","50","50","50","50","50","50","50","50","50","50","50"};
    String[] days = {"10","10","10","10","10","10","10","10","10","10","10","10"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mmlist = (ListView) findViewById(R.id.mylist1);
        CustAdapterFeature customAdapter = new CustAdapterFeature(FeatureActivity.this, names, images, place, discrate,price,days);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.home:
                        Intent iii = new Intent(FeatureActivity.this,MainActivity.class);
                        startActivity(iii);
                    ...
                    case R.id.signup:
                        ...
                        return true;
                    case R.id.filter:
                        Intent i21 = new Intent(FeatureActivity.this,FixturesListActivity.class);
                        startActivity(i21);
                        Toast.makeText(getApplicationContext(), "filter Selected", Toast.LENGTH_SHORT).show();
                        return true;
                    case R.id.nearme:
                        Intent i = new Intent(FeatureActivity.this,MapDitance.class);
                        startActivity(i);
                    ...
                    case R.id.favourites:
                        ...
                        return true;
                    case R.id.fetures:
                        Intent ii = new Intent(FeatureActivity.this,second.class);
                        startActivity(ii);
                    ...
                    case R.id.merchandise:
                        Intent i2 = new Intent(FeatureActivity.this,MerchandiesActivity.class);
                        startActivity(i2);
